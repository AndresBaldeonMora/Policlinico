  ...
  return (
    <div className="soap-content-inner">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          <label htmlFor="gastroenterologia-hPylori" className="soap-section-label">H. pylori (estado)</label>
          <select id="gastroenterologia-hPylori" className="soap-input" value={val('hPylori')} onChange={e => up('hPylori', e.target.value)}>
        ...
        <div>
          <label htmlFor="gastroenterologia-consumoAines" className="soap-section-label">Consumo de AINES</label>
          <select id="gastroenterologia-consumoAines" className="soap-input" value={val('consumoAines')} onChange={e => up('consumoAines', e.target.value)}>
            <option value="">Seleccionar</option>
            <option>No</option>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          <label htmlFor="gastroenterologia-pirosis" className="soap-section-label">Pirosis / Reflujo</label>
          <select id="gastroenterologia-pirosis" className="soap-input" value={val('pirosis')} onChange={e => up('pirosis', e.target.value)}>
            <option value="">Seleccionar</option>
        ...
        <div>
          ...
          <select id="gastroenterologia-disfagia" className="soap-input" value={val('disfagia')} onChange={e => up('disfagia', e.target.value)}>
            <option value="">Seleccionar</option>
            <option>Ausente</option>
        ...
        <div>
          <label htmlFor="gastroenterologia-habitoIntestinal" className="soap-section-label">Hábito intestinal</label>
          <select id="gastroenterologia-habitoIntestinal" className="soap-input" value={val('habitoIntestinal')} onChange={e => up('habitoIntestinal', e.target.value)}>
            <option value="">Seleccionar</option>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          <label htmlFor="gastroenterologia-hematoquecia" className="soap-section-label">Hematoquecia (sangre roja en heces)</label>
          <select id="gastroenterologia-hematoquecia" className="soap-input" value={val('hematoquecia')} onChange={e => up('hematoquecia', e.target.value)}>
            <option value="">Seleccionar</option>
            <option>No</option>
        ...
        <div>
          <label htmlFor="gastroenterologia-melena" className="soap-section-label">Melena (heces negras alquitranadas)</label>
          <select id="gastroenterologia-melena" className="soap-input" value={val('melena')} onChange={e => up('melena', e.target.value)}>
            <option value="">Seleccionar</option>
            <option>No</option>
            <option>Sí</option>
          </select>
