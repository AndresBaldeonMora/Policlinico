    ...
    <div className="soap-content-inner">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <input id="medicinafisica-tipoLesion" className="soap-input" value={val('tipoLesion')} onChange={e => up('tipoLesion', e.target.value)} placeholder="" />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="medicinafisica-dispositivosAsistencia" className="soap-input" value={val('dispositivosAsistencia')} onChange={e => up('dispositivosAsistencia', e.target.value)} placeholder="" />
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <input id="medicinafisica-barthel" className="soap-input" type="number" min="0" max="100" value={val('barthel')} onChange={e => up('barthel', e.target.value)} placeholder="" />
        ...
        <div>
          ...
          <input id="medicinafisica-lawtonBrody" className="soap-input" type="number" min="0" max="8" value={val('lawtonBrody')} onChange={e => up('lawtonBrody', e.target.value)} placeholder="" />
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <textarea id="medicinafisica-avdLimitadas" className="soap-input soap-textarea" style={{ minHeight: 56 }} value={val('avdLimitadas')} onChange={e => up('avdLimitadas', e.target.value)} placeholder="" />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <input id="medicinafisica-fuerzaEESD" className="soap-input" value={val('fuerzaEESD')} onChange={e => up('fuerzaEESD', e.target.value)} placeholder="" />
        </div>
        <div>
          <label htmlFor="medicinafisica-fuerzaEESI" className="soap-section-label">EESS Izquierda</label>
          <input id="medicinafisica-fuerzaEESI" className="soap-input" value={val('fuerzaEESI')} onChange={e => up('fuerzaEESI', e.target.value)} placeholder="" />
        </div>
        <div>
          <label htmlFor="medicinafisica-fuerzaEEID" className="soap-section-label">EEII Derecha</label>
          <input id="medicinafisica-fuerzaEEID" className="soap-input" value={val('fuerzaEEID')} onChange={e => up('fuerzaEEID', e.target.value)} placeholder="" />
        </div>
        <div>
          <label htmlFor="medicinafisica-fuerzaEEII" className="soap-section-label">EEII Izquierda</label>
          <input id="medicinafisica-fuerzaEEII" className="soap-input" value={val('fuerzaEEII')} onChange={e => up('fuerzaEEII', e.target.value)} placeholder="" />
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        ...
        <div>
          ...
          <input id="medicinafisica-contracturas" className="soap-input" value={val('contracturas')} onChange={e => up('contracturas', e.target.value)} placeholder="" />
        </div>
      </div>
      <div style={{ marginBottom: 14 }}>
        <label htmlFor="medicinafisica-romAfectado" className="soap-section-label">ROM principal afectado</label>
        <textarea id="medicinafisica-romAfectado" className="soap-input soap-textarea" style={{ minHeight: 56 }} value={val('romAfectado')} onChange={e => up('romAfectado', e.target.value)} placeholder="" />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        ...
        <div>
          ...
          <input id="medicinafisica-tinetti" className="soap-input" type="number" min="0" max="28" value={val('tinetti')} onChange={e => up('tinetti', e.target.value)} placeholder="" />
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <input id="medicinafisica-descripcionMarcha" className="soap-input" value={val('descripcionMarcha')} onChange={e => up('descripcionMarcha', e.target.value)} placeholder="" />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <input id="medicinafisica-doloreEva" className="soap-input" type="number" min="0" max="10" value={val('doloreEva')} onChange={e => up('doloreEva', e.target.value)} placeholder="" />
        </div>
        <div>
          <label htmlFor="medicinafisica-dolorLocalizacion" className="soap-section-label">Localización del dolor</label>
          <input id="medicinafisica-dolorLocalizacion" className="soap-input" value={val('dolorLocalizacion')} onChange={e => up('dolorLocalizacion', e.target.value)} placeholder="" />
        </div>
      </div>
      <div style={{ marginBottom: 14 }}>
        <label htmlFor="medicinafisica-dolorFactores" className="soap-section-label">Factores que mejoran / empeoran</label>
        <input id="medicinafisica-dolorFactores" className="soap-input" value={val('dolorFactores')} onChange={e => up('dolorFactores', e.target.value)} placeholder="" />
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          ...
          <textarea id="medicinafisica-modalidadesTerapeuticas" className="soap-input soap-textarea" style={{ minHeight: 56 }} value={val('modalidadesTerapeuticas')} onChange={e => up('modalidadesTerapeuticas', e.target.value)} placeholder="" />
        </div>
        <div>
          <label htmlFor="medicinafisica-objetivosFuncionales" className="soap-section-label">Objetivos funcionales</label>
          <textarea id="medicinafisica-objetivosFuncionales" className="soap-input soap-textarea" style={{ minHeight: 56 }} value={val('objetivosFuncionales')} onChange={e => up('objetivosFuncionales', e.target.value)} placeholder="" />
        </div>
      </div>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <textarea id="medicinafisica-notasAdicionales" className="soap-input soap-textarea" style={{ minHeight: 60 }} value={val('notasAdicionales')} onChange={e => up('notasAdicionales', e.target.value)} placeholder="" />
      </div>
