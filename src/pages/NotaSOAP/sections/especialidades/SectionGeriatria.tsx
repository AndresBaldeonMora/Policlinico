  ...
  return (
    <div className="soap-content-inner">
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <select id="geriatria-quejasMemoria" className="soap-input" value={val('quejasMemoria')} onChange={e => up('quejasMemoria', e.target.value)}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          <label htmlFor="geriatria-gds" className="soap-section-label">GDS - Escala de Depresión Geriátrica</label>
          <select id="geriatria-gds" className="soap-input" value={val('gds')} onChange={e => up('gds', e.target.value)}>
            <option value="">Seleccionar</option>
        ...
        <div>
          <label htmlFor="geriatria-ideacionSuicida" className="soap-section-label">Ideación suicida</label>
          <select id="geriatria-ideacionSuicida" className="soap-input" value={val('ideacionSuicida')} onChange={e => up('ideacionSuicida', e.target.value)}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        ...
        <div>
          ...
          <select id="geriatria-incontinenciaUrinaria" className="soap-input" value={val('incontinenciaUrinaria')} onChange={e => up('incontinenciaUrinaria', e.target.value)}>
            <option value="">Seleccionar</option>
        ...
        <div>
          <label htmlFor="geriatria-ulcerasPresion" className="soap-section-label">Úlceras por presión</label>
          <select id="geriatria-ulcerasPresion" className="soap-input" value={val('ulcerasPresion')} onChange={e => up('ulcerasPresion', e.target.value)}>
            <option value="">Seleccionar</option>
            <option>No</option>
      ...
      <div style={{ marginBottom: 14 }}>
        <label htmlFor="geriatria-estadoNutricional" className="soap-section-label">Estado nutricional</label>
        <select id="geriatria-estadoNutricional" className="soap-input" value={val('estadoNutricional')} onChange={e => up('estadoNutricional', e.target.value)}>
          <option value="">Seleccionar</option>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
        <div>
          <label htmlFor="geriatria-convivencia" className="soap-section-label">Situación de convivencia</label>
          <select id="geriatria-convivencia" className="soap-input" value={val('convivencia')} onChange={e => up('convivencia', e.target.value)}>
            <option value="">Seleccionar</option>
        ...
        <div>
          <label htmlFor="geriatria-redApoyoFamiliar" className="soap-section-label">Red de apoyo familiar</label>
          <select id="geriatria-redApoyoFamiliar" className="soap-input" value={val('redApoyoFamiliar')} onChange={e => up('redApoyoFamiliar', e.target.value)}>
            <option value="">Seleccionar</option>
      ...
      <div style={{ marginBottom: 14 }}>
        <label htmlFor="geriatria-maltratoAbandono" className="soap-section-label">Signos de maltrato o abandono</label>
        <select id="geriatria-maltratoAbandono" className="soap-input" value={val('maltratoAbandono')} onChange={e => up('maltratoAbandono', e.target.value)}>
          <option value="">Seleccionar</option>
